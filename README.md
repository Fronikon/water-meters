...
## Что можно улучшить
- сделать "оптимистичное" переключение страниц
- добавить адаптив под планшеты и смартфоны
- выводить сообщения об ошибках во всплывающие окна
- адаптировать размер колонок под контент (это отлично работает при использовании table, но накладывает другие ограничения, такие как: работа с внутренним скроллом и бордер радиусом у таблицы)
